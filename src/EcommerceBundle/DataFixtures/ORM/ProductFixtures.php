...
class ProductFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $produit2->setTaxe($this->getReference('tva2'));
        ...
        $produit3->setTaxe($this->getReference('tva2'));
        ...
        $produit4->setTaxe($this->getReference('tva2'));
        ...
        $produit5->setTaxe($this->getReference('tva2'));
        ...
        $produit6->setTaxe($this->getReference('tva2'));
