...
class CategoryAdminController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('EcommerceBundle\Form\CategoryType', $category);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('adminCategory_show', array('id' => $category->getId()));
        }
    ...
    public function editAction(Request $request, Category $category)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('adminCategory_edit', array('id' => $category->getId()));
        }
    ...
    public function deleteAction(Request $request, Category $category)
    {
        ...
        return $this->redirectToRoute('adminCategory_index');
    }
